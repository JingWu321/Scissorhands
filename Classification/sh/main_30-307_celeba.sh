...
# # SHs
# python -u main_forget.py --seed=2 --gpu 0 --data '/home/jing/dataset/CelebAMaskHQ/CelebA_HQ_facial_identity_dataset' --dataset 'celeba' --save_dir './_results/celeba/seed2/SHs/lr2e-4_s95_lam0.5_E5P1M1' --mask './_results/celeba/raw/rawcheckpoint.pth.tar' --print_freq=10 --unlearn SHs  --unlearn_epochs 5 --unlearn_lr 2e-4 --sparsity 0.95 --lam 0.5 --project --memory_num 1 --prune_num 1 --arch "resnet34" --input_size 224 --batch_size 8 --num_classes 307
